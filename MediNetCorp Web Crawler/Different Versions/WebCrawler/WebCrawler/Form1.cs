...
namespace WebCrawler
{
    public partial class Form1 : Form
    {
        ...
        {          
            ...
            if (cmbjob.Text == "All Jobs")
            {
                ...
                foreach (string s in arr)
                {
                    ...
                    {
                        baseuri = ".craiglist.org/search/acc?query=";
                    }
                    else if (s == "Admin + Office")
                    {
                        baseuri = ".craiglist.org/search/ofc?query=";
                    }
                    else if (s== "Arch + Engineering")
                    {
                        baseuri = ".craiglist.org/search/egr?query=";
                    }
                    else if (s == "Art + Media + Design")
                    {
                        baseuri = ".craiglist.org/search/med?query=";
                    }
                    else if (s == "Biotech + Science")
                    {
                        baseuri = ".craiglist.org/search/sci?query=";
                    }
                    else if (s == "Business + Management")
                    {
                        baseuri = ".craiglist.org/search/bus?query=";
                    }
                    else if (s == "Customer Service")
                    {
                        baseuri = ".craiglist.org/search/csr?query=";
                    }
                    else if (s == "Education")
                    {
                        baseuri = ".craiglist.org/search/edu?query=";
                    }
                    else if (s == "Food + Bev + Hosp")
                    {
                        baseuri = ".craiglist.org/search/fbh?query=";
                    }
                    else if (s == "General Labor")
                    {
                        baseuri = ".craiglist.org/search/lab?query=";
                    }
                    else if (s == "Government")
                    {
                        baseuri = ".craiglist.org/search/gov?query=";
                    }
                    else if (s == "Human Resources")
                    {
                        baseuri = ".craiglist.org/search/hum?query=";
                    }
                    else if (s == "Internet Engineers")
                    {
                        baseuri = ".craiglist.org/search/eng?query=";
                    }
                    else if (s == "Legal + Paralegal")
                    {
                        baseuri = ".craiglist.org/search/lgl?query=";
                    }
                    else if (s == "Manufacturing")
                    {
                        baseuri = ".craiglist.org/search/mnu?query=";
                    }
                    else if (s == "Marketing + Pr + Ad")
                    {
                        baseuri = ".craiglist.org/search/mar?query=";
                    }                   
                    else if (s == "Nonprofit Sector")
                    {
                        baseuri = ".craiglist.org/search/npo?query=";
                    }
                    else if (s == "Real Estate")
                    {
                        baseuri = ".craiglist.org/search/rej?query=";
                    }
                    else if (s == "Retail + Wholesale")
                    {
                        baseuri = ".craiglist.org/search/ret?query=";
                    }
                    else if (s== "Sales + Biz Dev")
                    {
                        baseuri = ".craiglist.org/search/sls?query=";
                    }
                    else if (s == "Salon + Spa + Fitness")
                    {
                        baseuri = ".craiglist.org/search/spa?query=";
                    }
                    else if (s== "Security")
                    {
                        baseuri = ".craiglist.org/search/sec?query=";
                    }
                    else if (s == "Skilled Trade + Craft")
                    {
                        baseuri = ".craiglist.org/search/trd?query=";
                    }
                    else if (s == "Software + Ga + Dba")
                    {
                        baseuri = ".craiglist.org/search/sof?query=";
                    }
                    else if (s == "Systems + Network")
                    {
                        baseuri = ".craiglist.org/search/sad?query=";
                    }
                    else if (s == "Technical Support")
                    {
                        baseuri = ".craiglist.org/search/tch?query=";
                    }
                    else if (s == "Transport")
                    {
                        baseuri = ".craiglist.org/search/trp?query=";
                    }
                    else if (s == "Tv + Film + Video")
                    {
                        baseuri = ".craiglist.org/search/tfr?query=";
                    }
                    else if (s == "Web + Info Design")
                    {
                        baseuri = ".craiglist.org/search/web?query=";
                    }
                    else if (s == "Writing + Editing")
                    {
                        baseuri = ".craiglist.org/search/wri?query=";
                    }
                    else if (s == "[ETC]")
                    {
                        baseuri = ".craiglist.org/search/etc?query=";
                    }
                    else if (s == "[Part-Time]")
                    {
                        baseuri = ".craiglist.org/search/jjj?is_parttime=1&query=";
                    }
            ...
            {
                baseuri = ".craiglist.org/search/hea?query=";
            }

            // pattern matching string
            if (cmblink.Text == "Full Link")
            {
               pattern = @"((([A-Za-z]{3,9}:(?:\/\/)?)(?:[-;:&=\+\$,\w]+@)?[A-Za-z0-9.-]+|(?:www.|[-;:&=\+\$,\w]+@)[A-Za-z0-9.-]+)((?:\/[\+~%\/.\w-_]*)?\??(?:[-\+=&;%@.\w_]*)#?(?:[\w]*))?)";

            }
            else if(cmblink.Text=="Half Link")
            {
               pattern = @"href=\""(.*?)\""";
            }
            try
            {
                ...
                if (cmbstate.Text=="" || txtkeyword.Text == "" || cmblink.Text =="" || cmbjob.Text=="")
                {
                    ...
                    if (cmbstate.Text == "Alabama")
                        {
                             ...
                             foreach (string s in arr)
                             {
                                 if (s == "auburn")
                                 {
                                     string additionalurl = "http://" + s + ".craiglist.org";
                                     
                                     string searchuri = "http://" + s + baseuri + txtkeyword.Text;

                                     MatchUrl(pattern, searchuri, additionalurl, cmbjob.Text, cmblink.Text, cmbstate.Text, txtkeyword.Text);
                                 ...
                                 else if (s == "birmingham")
                                 {
                                     ...
                                     string additionalurl = "http://" + rv + ".craiglist.org";
        ...
        private void MatchUrl(string pattern1, string searchuri1, string url, string cmbjob, string cmblink, string cmbstate, string keyword)
        {
            ...
            //Set up regex object 
            Regex RegExpr = new Regex(pattern1, RegexOptions.IgnoreCase);

            //get the first match 
            Match match = RegExpr.Match(responseData);
            while (match.Success)
            {
                if (cmblink == "Full Link")
                {
                    string dum = match.Groups[1].Value;
                    
                    if (dum.EndsWith(".html") == true)
                    {
                        //Regex RE = new Regex(@"[^/]*(?=\.html.*$)");
                        //Match match2 = RE.Match(dum);

                        //while (match2.Success)
                        //{
                        //    string myFileName = match2.Value;
                        //    list.Add(myFileName);
                        //    match2 = match2.NextMatch();
                        //}                                       
            
                        GradNextLink(dum,url);
                      // WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", match.Groups[1].Value);
                        
                    }
                    
                }
                if (cmblink == "Half Link")
                {
                    string dum1 = match.Groups[1].Value;
                    ...
                    if (cmbjob == "All Jobs")
                    {
                        ...
                        foreach (string s in arr)
                        {
                            if (s == "Accounting + Finance")
                            {
                                if (dum1.StartsWith("/acc") == true && dum1.EndsWith(".html") == true)
                                {

                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                            }
                            else if (s == "Admin + Office")
                            {
                                if (dum1.StartsWith("/ofc") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/egr") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/med") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/sci") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/bus") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/csr") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/edu") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/fbh") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/lab") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/gov") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/hum") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/eng") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/lgl") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/mnu") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/mar") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/npo") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/rej") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/ret") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/sls") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/spa") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/sec") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/trd") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/sof") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/sad") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/tch") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/trp") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/tfr") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/web") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/wri") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            {
                                if (dum1.StartsWith("/etc") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                            ...
                            else if (s == "[Part-Time]")
                            {
                                ...
                                else if (dum1.StartsWith("/sci") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/lgl") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/egr") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/med") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/gov") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/hum") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/eng") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/mnu") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/rej") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/spa") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/sof") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/sad") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/tch") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/tfr") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/fbh") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/mar") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/ofc") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/edu") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/csr") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/sec") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/sls") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/bus") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/lab") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/npo") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/web") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/trp") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/wri") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                                }
                                else if (dum1.StartsWith("/ret") == true && dum1.EndsWith(".html") == true)
                                {
                                    WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
                                ...
                                else if (dum1.StartsWith("/acc") == true && dum1.EndsWith(".html") == true)
                                {
                    ...
                    {
                        if (dum1.StartsWith("/nva") == true)
                        {
                            WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                        }
                        if (dum1.StartsWith("/mld") == true)
                        {
                            WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                        }
                        if (dum1.StartsWith("/doc") == true)
                        {
                            WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                        }

                        if (dum1.StartsWith("/oah") == true)
                        {
                            WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                        }

                        if (dum1.StartsWith("/mau") == true)
                        {
                            WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                        }

                        if (dum1.StartsWith("/big") == true)
                        {
                            WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);

                        }
                        if (dum1.StartsWith("/hea") == true)
                        {
                            WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + cmbjob + " " + cmblink + " " + cmbstate + " " + keyword + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", url + match.Groups[1].Value);
         ...
         //   MessageBox.Show(terms.Length.ToString());
        }
        ...
        public void GradNextLink(string link, string url2)
        {          
            string pattern1 = @"href=\""(.*?)\""";
            //MessageBox.Show(link);
           // MessageBox.Show(url2);
            string orgappend = ".org";
           // string[] split = link.Split(new Char[] { '/' });
            string result4 = link.Substring(0, link.IndexOf(".org")) + orgappend;
            
            HttpWebRequest httpReq1 = (HttpWebRequest)WebRequest.Create(link);
            HttpWebResponse httpRes1 = (HttpWebResponse)httpReq1.GetResponse();
            StreamReader sr1 = new StreamReader(httpRes1.GetResponseStream());
            string responseData1 = sr1.ReadToEnd();
            Regex RegExpr = new Regex(pattern1, RegexOptions.IgnoreCase);

            //get the first match 
            Match match = RegExpr.Match(responseData1);
            while (match.Success)
            {
                string dum = match.Groups[1].Value;
                if (dum.StartsWith("/reply") == true)
                {
                    //WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", match.Groups[1].Value);
                   
                   // MessageBox.Show(result4+dum);
                    GrabNextLink2(result4 + dum);
                }
               match = match.NextMatch();
            }         
       ...
       public void GrabNextLink2(string link)
        {
             
           // string dum3= link.Replace(".html", "");
             //MessageBox.Show(link);
            string pattern1 = @"href=\""(.*?)\""";
             HttpWebRequest httpReq1 = (HttpWebRequest)WebRequest.Create(link);
             HttpWebResponse httpRes1 = (HttpWebResponse)httpReq1.GetResponse();
             ...
             {
                 string dum = match.Groups[1].Value;
                 if (dum.StartsWith("mail.google.com") == true)
                 {
                     //WriteToLog(System.AppDomain.CurrentDomain.BaseDirectory + DateTime.Now.ToString("  dd-MM-yyyy-hh") + ".xls", match.Groups[1].Value);
                     MessageBox.Show(dum);
                     //GrabNextLink2(dum);
